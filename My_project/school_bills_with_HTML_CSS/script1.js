...
$("form").submit(function (e) {
  ...
  $("body").on("click", ".btn-update", function () {
    ...
    var Course_Language = $(this)
      .parents("tr")
      .find("input[name='Course_Language']")
      .val();
    var date_of_registration = $(this)
      .parents("tr")
      .find("input[name='date_of_registration']")
      .val();
    
     //create a new row in list
    $(this).parents("tr").find("td:eq(0)").text(Course_Title);
    $(this).parents("tr").find("td:eq(1)").text(Course_Language);
    $(this).parents("tr").find("td:eq(2)").text(date_of_registration);
